...
public class ReservationsController {
	...
	public static void showAllReservations(ArrayList<Reservation> reservations, Scanner scanner) {
	 ...
	 public static void getAllReservationbyGuestName(ArrayList<Reservation> reservations, Scanner scanner) {
	 ...
	 public static void getAllReservationbyGuestId(ArrayList<Reservation> reservations, Scanner scanner) {
